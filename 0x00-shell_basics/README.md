...
File 18-commas writes a command that lists all the files and directories of the current directory, separated by commas (,).File 0-current_working_directory prints the current working directory.
